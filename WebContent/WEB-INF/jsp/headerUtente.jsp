...
<link href="resources/dataTables.bootstrap4.min.css"
	rel="stylesheet" crossorigin="anonymous">
<link
	href="https://fonts.googleapis.com/css?family=Arvo:700i|Kaushan+Script&display=swap"
	rel="stylesheet">

<script src="resources/all.min.js.download"
		...
		<nav class="sb-sidenav accordion sb-sidenav-dark"
			...
			<div class="sb-sidenav-menu">
				...
				<div class="sb-sidenav-menu-heading">Prenotazioni</div>
					...
					<a class="nav-link" href="file:///C:/Users/Computer/Desktop/startbootstrap-sb-admin-gh-pages/dist/charts.html">
						<div class="sb-nav-link-icon">
							<svg class="svg-inline--fa fa-chart-area fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chart-area" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
